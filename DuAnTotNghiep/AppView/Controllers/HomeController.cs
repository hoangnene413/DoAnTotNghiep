    ...
    public class HomeController : Controller
    {
        ...
        public string Order(HoaDonViewModel hoaDon)
        {
            try
            {
                ...
                else if (hoaDon.PhuongThucThanhToan == "VNPay")
                {
                    ...
                    string vnp_TmnCode = "XOE59VVS"; //Ma định danh merchant kết nối (Terminal Id)
                    string vnp_HashSecret = "TGBT0LT6POB41BYJNDA1ZZ1PO33VWH1J"; //Secret Key
        ...
        public IActionResult PaymentCallBack()
        {
            try
            {
                ...
                {
                    string vnp_HashSecret = "TGBT0LT6POB41BYJNDA1ZZ1PO33VWH1J"; //Chuoi bi mat
